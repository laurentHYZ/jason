...
A skilled cook with access to food storage
...
** Nerd Alert!
You might read that "Python is an interpreted language blabla" but we will only go there in due time and that's not now.
